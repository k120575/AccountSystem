...
public class InquiryServiceImpl implements InquiryService {
    ...
    public String doSearch(String startDate, String endDate, Integer page, Integer size, Model model, HttpServletRequest req) {
        ...
        if (!Objects.equals(startDate, "") && !Objects.equals(endDate, "")){
            List<AccountDetail> accountDetails = accountDetailRepository.findByCreateUserAndCreateTimeBetweenOrderByCreateTimeDesc(
                    name, LocalDateTime.parse(startDate + " 00:00:00", dtf2), LocalDateTime.parse(endDate + " 23:59:59", dtf2));
